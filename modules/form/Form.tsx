  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center mt-24">
        ...
        <div className="flex flex-col -translate-y-8 px-8 lg:shadow-form lg:bg-white lg:items-start lg:p-16 z-10">
          <div className="flex flex-col gap-y-2">
            <div className="flex items-start">
              <span className="font-cairo font-bold text-2xl">UMÓW JAZDĘ PRÓBNĄ</span>
              <span className="font-cairo font-bold text-sm ml-1 mt-[1px]">BMW iX</span>
            </div>
        ...
        {/* SECOND CAR - mobile */}
        <div className="relative overflow-hidden w-full lg:hidden">
          <Image src={BMWside} alt="bmw_front" className="absolute -right-52 z-10" />
          <Image
            src={Triangle1}
            alt="triangle2"
            className="relative translate-x-36 -translate-y-24"
          />
        </div>
      </div>
    </>
